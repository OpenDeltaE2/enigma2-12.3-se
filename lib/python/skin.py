...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "delta-neon-fhd/skin.xml" or "delta-purple-fhd/skin.xml"  # SD hardware is no longer supported by the default skin.
