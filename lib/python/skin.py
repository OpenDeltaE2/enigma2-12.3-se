...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "skins-delta-blackred-fhd/skin.xml" or "AREADELTASAT-FHD/skin.xml"  # SD hardware is no longer supported by the default skin.
