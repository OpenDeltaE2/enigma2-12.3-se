...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "delta-blackred-fhd/skin.xml" or "AREADELTASAT_FHD/skin.xml"  # SD hardware is no longer supported by the default skin.
